(async function() {
  ...
  // --- Configuration ---
  const issues = [
    { issue: 'v3-i1', title: 'Vol 3, Issue 1', date: '2025-10-01', excerpt: 'The bird is back, new faculty, and more!'},
    ...
    { issue: 'v1-i1', title: 'Vol 1, Issue 1', date: '2023-12-01', excerpt: 'The very first issue! Read about the relaunch of the newspaper and more.' }
